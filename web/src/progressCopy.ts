...
const COPY_POR_TOOL: Record<string, string> = {
  ...
  get_financial_profile: "Analizando tus últimos 12 meses…",
  get_recommendations: "Buscando lo que más te conviene…",
  simulate_debt_payoff: "Calculando tu plan de pago…",
